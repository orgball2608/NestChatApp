export enum Routes {
    ...
    MESSAGES_STATUS = 'conversations/:id/messages/:messageId/statuses/',
    GROUPS = 'groups',
    GROUP_MESSAGES = 'groups/:id/messages',
    GROUP_MESSAGE_STATUSES = 'groups/:id/messages/:messageId/statuses/',
...
export enum Services {
    ...
    GROUP_MESSAGE_STATUS = 'GROUP_MESSAGE_STATUS_SERVICE',
